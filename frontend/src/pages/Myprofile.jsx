  ...
  return (
    userData && (
      <div className='max-w-lg flex flex-col gap-3 text-sm'>
        {Isedit ? (
          <label htmlFor='image'>
            <div className='inline-block relative cursor-pointer'>
              ...
              />
              {!image && (
                <FiUpload className='absolute bottom-12 right-12 text-3xl text-white bg-black/40 rounded-full p-1' />
              )}
            </div>
            <input
        ...
        {Isedit ? (
          <input
            className='bg-gray-200 text-3xl font-medium max-w-60 mt-4 px-1 rounded-sm'
            type='text'
            value={userData.name}
        ...
        <div>
          ...
          <div className='grid grid-cols-[1fr_3fr] gap-y-1.5 mt-3 text-neutral-700'>
            ...
            {Isedit ? (
              <input
                className='bg-gray-100 max-w-[13.5em] rounded-sm'
                type='text'
            ...
            {Isedit ? (
              <p>
                <input
                  className='bg-gray-50 rounded-sm mb-1 mt-2'
                  type='text'
                  onChange={(e) =>
                    setuserData((prev) => ({
                      ...prev,
        ...
        <div>
          ...
          <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
            ...
            {Isedit ? (
              <select
                className='max-w-20 max-h-6 mt-3 bg-gray-100 rounded-sm'
                onChange={(e) =>
            ...
            {Isedit ? (
              <input
                className='max-w-[7rem] max-h-6 mb-3 text-center bg-gray-100 rounded-sm'
                type='date'
                onChange={(e) =>
        ...
        <div>
          {Isedit ? (
            <button
              className='my-3 border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all duration-500'
